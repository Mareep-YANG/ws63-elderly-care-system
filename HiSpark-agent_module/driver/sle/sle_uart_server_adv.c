...
/* 广播名称 */
static uint8_t sle_local_name[NAME_MAX_LENGTH] = "hisoc -AIBoard";
unsigned char local_addr[SLE_ADDR_LEN] = {0x02, 0x02, 0x03, 0x04, 0x05, 0x06};
#define SLE_SERVER_INIT_DELAY_MS 1000
#define sample_at_log_print(fmt, args...) log_info(fmt, ##args)
